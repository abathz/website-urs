...
<section class="parallax-section clearfix history" id="history">
    <div class="mid-content">
        <div class="row">
            <div class="column">
                <h1 class="u-pull-left" style="letter-spacing: 5px;">History</h1>
            </div>
        </div>
        <div class="row">
            <div class="one-half column u-pull-right">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas non felis convallis odio condimentum cursus nec at arcu. Sed eget nisi feugiat, dignissim risus eget, pulvinar lacus. Aliquam cursus elit ac feugiat condimentum. Maecenas vulputate tortor at iaculis mollis. Nulla in nisi dolor. Phasellus bibendum eget magna nec rutrum. Curabitur cursus magna vehicula purus egestas, id convallis dolor tincidunt. Pellentesque quis neque metus. Cras viverra scelerisque velit. Nullam et arcu a libero euismod ornare vel ut ex. Nulla facilisi. Quisque sed ligula magna. Phasellus elementum id dolor et pulvinar.</p>
            </div>
        </div>
    </div>
</section>
<section class="parallax-section clearfix division" id="division">
    <div class="mid-content">
        <div class="row">
            <div class="column">
                <h1 class="u-pull-left" style="letter-spacing: 5px;">Division</h1>
            </div>
        </div>
        <div class="row">
            ...
            <div class="ten columns">
                <div class="team-listing clearfix u-pull-right">
                    <div class="team-tab">
